...
import { User, Settings, Shield, Pencil } from "lucide-react";
...
type Tab = "overview" | "edit" | "security" | "settings";

const TABS: { id: Tab; key: string; icon: typeof User }[] = [
  { id: "overview", key: "profile.tab_profile", icon: User },
  { id: "edit", key: "profile.tab_edit", icon: Pencil },
  { id: "security", key: "profile.tab_security", icon: Shield },
  { id: "settings", key: "profile.tab_settings", icon: Settings },
];
        ...
        <GlassPanel className="relative overflow-hidden p-6 md:p-8">
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              {profile?.bio && (
                <p className="mt-2 text-sm text-muted-foreground/80">{profile.bio}</p>
              )}
