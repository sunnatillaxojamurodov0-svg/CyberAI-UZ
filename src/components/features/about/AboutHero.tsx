  ...
  return (
    <section className="relative overflow-hidden px-6 pt-32 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          <StatusPill tone="accent">Origin Document // CLASSIFIED</StatusPill>
        </motion.div>
        ...
        >
          ...
          <span className="gradient-text">after the alarm.</span>
        </motion.h1>
        ...
        >
          CyberAI exists because the synthetic era doesn't sleep — and neither
          does the threat. We build sovereign intelligence for the operators
          who hold the line when seconds become casualties.
        </motion.p>
