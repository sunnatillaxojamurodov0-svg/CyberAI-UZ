...
import { getSessionToken, verifySession, setup2FA, enable2FA, disable2FA, is2FAEnabled } from "@/lib/auth/auth-server";
import { setup2FA as setupTOTP, enable2FA as enableTOTP, disable2FA as disableTOTP, verify2FA as verifyTOTP, is2FAEnabled as check2FA } from "@/lib/auth/totp";
      ...
      POST: async ({ request }) => {
        try {
          ...
          if (body.action === "setup") {
            ...
            return new Response(JSON.stringify({ ok: true, secret: result.secret, qrCodeUrl: result.qrCodeUrl }), {
              headers: { "Content-Type": "application/json" },
            });
          }
