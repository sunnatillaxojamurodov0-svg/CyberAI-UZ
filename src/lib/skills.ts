...
const KALI_LINUX_PROMPT =
  "Administer Kali Linux without flattening it into Debian or a bag of offensive tools. Identify your Kali lane: rolling install, last-snapshot, live USB, VM image, Purple image, NetHunter, or lab box. Separate base OS health from tool-selection, branch hygiene, hardware support, and engagement scope. Handle Kali-specific issues: branch mixing, metapackage sprawl, stale images, persistence mistakes, and hardware edge cases.";

const KALI_TOOLS_PROMPT =
  "Comprehensive guidance on penetration testing tools including Nmap, Metasploit, Burp Suite, John the Ripper, Hydra, and other Kali tools. Expertise in tool selection, configuration, and exploitation workflows. Focus on practical security testing techniques and methodologies.";

const UI_UX_PROMPT =
  "UI/UX Pro Max - Design Intelligence. Comprehensive design guide with 50+ styles, 161 color palettes, 57 font pairings, and 25 chart types. Use this skill for UI structure, visual design decisions, interaction patterns, and UX quality control. Essential for designing new pages, creating components, choosing design systems, and reviewing UI code for accessibility and consistency.";
...
export const SKILLS: Skill[] = [
  ...
  },
  {
    ...
    promptPrefix:
      "You are now in Coding expert mode. Provide production-grade code, architecture advice, debugging, and engineering best practices.",
  },
  {
    id: "pentesting",
    label: "Pentesting",
    ...
    promptPrefix:
      "You are now in Pentesting expert mode. Provide authorized penetration testing guidance, vulnerability assessment, and exploitation techniques.",
  },
  {
    id: "ai",
    ...
    promptPrefix:
      "You are now in AI & Machine Learning expert mode. Provide guidance on machine learning models, neural networks, data science, and AI implementation.",
  },
  {
    id: "devops",
    ...
    promptPrefix:
      "You are now in DevOps expert mode. Provide guidance on CI/CD pipelines, cloud platforms, containerization, Kubernetes, and infrastructure as code.",
  },
];
