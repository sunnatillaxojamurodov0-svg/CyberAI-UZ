export function AnimatedGrid({ className = "" }: { className?: string }) {
  return (
    ...
    >
      ...
      <div
        className="absolute -top-40 left-1/2 -translate-x-1/2 h-[520px] w-[920px] rounded-full opacity-50 blur-[120px]"
        style={{
          background:
      ...
      />
      <div
        className="absolute top-40 right-0 h-[420px] w-[420px] rounded-full opacity-40 blur-[120px]"
        style={{
          background:
