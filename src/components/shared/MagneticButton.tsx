...
export function MagneticButton({
  ...
  const base = "relative inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-lg text-sm font-semibold tracking-tight transition-colors active:scale-[0.98] will-change-transform";
  const styles =
    variant === "primary"
