...
const PROMPTS: Prompt[] = [
  {
    ...
    description:
      "Audit all active user sessions across infrastructure for anomalies, privilege escalations, and policy violations.",
  ...
  },
  {
    ...
    description:
      "Review and validate firewall rule sets against least-privilege principles and compliance frameworks.",
  ...
  },
  {
    ...
    description:
      "Execute a structured containment sequence with isolation and evidence preservation for an active security incident.",
  ...
  },
  {
    ...
    description:
      "Proactively search for indicators of compromise across endpoints, network flows, and log sources.",
  ...
  },
  {
    ...
    description:
      "Analyze source code or compiled artifacts for security vulnerabilities, hardcoded secrets, and logic errors.",
  ...
  },
  {
    ...
    description:
      "Review application architecture for security, scalability, and adherence to best practices and design patterns.",
  ...
  },
  {
    ...
    description:
      "Generate a hardened configuration baseline across cloud, container, and on-premise infrastructure layers.",
  ...
  },
  {
    ...
    description:
      "Automate audit evidence collection for SOC 2, ISO 27001, PCI-DSS, or custom frameworks.",
  ...
  },
  {
    ...
    description:
      "Audit Kubernetes RBAC configurations for privilege escalation, wildcard bindings, and excessive permissions.",
  ...
  },
  {
    ...
    description:
      "Execute a structured malware analysis pipeline for suspicious binaries, scripts, or memory dumps.",
  ...
  },
  {
    ...
    description:
      "Collect and correlate threat intelligence from dark web forums, marketplaces, and paste sites related to your organization.",
  ...
  },
  {
    ...
    description:
      "Assess REST, GraphQL, or gRPC API endpoints for authentication flaws, injection, and data exposure risks.",
  ...
  },
  {
    ...
    description:
      "Scan container images and runtime configurations for vulnerabilities, misconfigurations, and policy violations.",
  ...
  },
  {
    ...
    title: "GDPR Data Map",
    description:
      "Map data flows, processing activities, and consent mechanisms to demonstrate GDPR compliance.",
  ...
  },
  {
    ...
    description:
      "Analyze CloudTrail / audit logs for anomalous API calls, privilege escalation, and unauthorized resource creation.",
  ...
  },
  {
    ...
    description:
      "Execute structured ransomware response including containment, negotiation preparation, and recovery procedures.",
  ...
  },
  {
    ...
    description:
      "Correlate network flow logs with threat intelligence feeds to detect C2 communication and data exfiltration.",
  ...
  },
  {
    ...
    description:
      "Scan Terraform, CloudFormation, and Pulumi templates for security misconfigurations and compliance violations.",
  ...
  },
  {
    ...
    description:
      "Review and simplify IAM policies across cloud providers to eliminate privilege creep and unused permissions.",
  ...
  },
  {
    ...
    description:
      "Perform forensic collection of volatile and non-volatile data from compromised systems with chain of custody.",
  ...
  },
  {
    ...
    description:
      "Assess the impact and exploitability of newly disclosed vulnerabilities in your technology stack.",
  ...
  },
  {
    ...
    description:
      "Correlate logs from multiple sources (SIEM, endpoints, network) to detect complex attack chains.",
  ...
  },
  {
    ...
    description:
      "Validate PCI-DSS compliance for cardholder data environments including ASV scanning and evidence collection.",
  ...
  },
  {
    ...
    description:
      "Design a realistic red team exercise scenario tailored to your infrastructure, threat model, and security controls.",
  ...
  },
  {
    ...
    description:
      "Create a comprehensive SOC runbook with triage, escalation, and response procedures for common alert types.",
  ...
  },
  {
    ...
    description:
      "Assess third-party vendor security posture, software supply chain risks, and open-source dependency hygiene.",
  ...
  },
  {
    ...
    description:
      "Analyze Active Directory for signs of compromise: Golden Ticket, DCSync, Kerberoasting, and ACL abuse.",
  ...
  },
  {
    ...
    description:
      "Respond to security incidents in Kubernetes clusters including container breakout, cryptomining, and RBAC abuse.",
  ...
  },
  {
    ...
    description:
      "Inventory and validate all cryptographic assets: certificates, keys, HSMs, and cipher suites across infrastructure.",
  ...
  },
  {
    ...
    description:
      "Assess DLP controls across endpoint, network, and cloud channels to prevent sensitive data exfiltration.",
      ...
      <div className="flex items-start gap-4 px-5 py-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2.5">
            <h3 className="text-sm font-semibold tracking-tight text-foreground">{prompt.title}</h3>
            {/* Tags */}
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <p className="max-w-xl text-base leading-relaxed text-muted-foreground">
            Pre-approved prompt templates developed by CyberAI operators. Click any card to view the
            full template — copy and adapt to your environment.
          </p>
        </motion.div>
            ...
            >
              ...
              {filtered.length > 5 && (
                <div className="flex justify-center pt-4">
                  <Link
                    to="/prompts"
                    className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface-2 px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-surface-3 hover:border-primary/40"
                  >
                    More
                  </Link>
                </div>
