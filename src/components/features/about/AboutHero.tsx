  ...
  return (
    <section className="relative overflow-hidden px-6 pt-32 pb-20">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        >
          Built for the{" "}
          <span className="gradient-text">moment after the alarm.</span>
        </motion.h1>
        ...
        >
          CyberAI exists because the synthetic era never sleeps — and neither do the threats. We build
          sovereign intelligence for the operators who hold the line when seconds become casualties.
        </motion.p>
