...
interface __BaseEnv_Env {
  ...
  CHALLENGE_GENERATOR: Workflow<
    Parameters<import("./.output/server/index").ChallengeGenerator["run"]>[0]["payload"]
  >;
  USER_ONBOARDING: Workflow<
    Parameters<import("./.output/server/index").UserOnboarding["run"]>[0]["payload"]
  >;
  CONSOLE_ANALYSIS: Workflow<
    Parameters<import("./.output/server/index").ConsoleAnalysis["run"]>[0]["payload"]
  >;
}
