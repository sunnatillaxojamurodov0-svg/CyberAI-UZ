/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 269c091726f5bf81e8bc9d1f72903990)
// Runtime types generated with workerd@1.20260521.1 2026-05-28 nodejs_compat
interface __BaseEnv_Env {
	CYBERAI_KV: KVNamespace;
	MY_BUCKET: R2Bucket;
	cyberai_db: D1Database;
	VECTORIZE_INDEX: VectorizeIndex;
	ANALYTICS: AnalyticsEngineDataset;
	AI_USAGE_QUEUE: Queue;
	MY_RATE_LIMITER_CHAT: RateLimit;
	MY_RATE_LIMITER_AUTH: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	...
	CONSOLE_SESSION_DO: DurableObjectNamespace<import("./.output/server/index").ConsoleSessionDO>;
	CHALLENGE_GENERATOR: Workflow<Parameters<import("./.output/server/index").ChallengeGenerator['run']>[0]['payload']>;
	USER_ONBOARDING: Workflow<Parameters<import("./.output/server/index").UserOnboarding['run']>[0]['payload']>;
	CONSOLE_ANALYSIS: Workflow<Parameters<import("./.output/server/index").ConsoleAnalysis['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.output/server/index");
		durableNamespaces: "ChatSessionDO" | "ConsoleSessionDO";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "OPENROUTER_API_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET">> {}
}
