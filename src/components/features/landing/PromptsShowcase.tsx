...
const CATEGORIES: Category[] = [
  { id: "security-audit", translationKey: "prompts.category.security_audit", icon: ShieldCheck },
  {
    id: "incident-response",
    translationKey: "prompts.category.incident_response",
    icon: AlertTriangle,
  },
  { id: "threat-intel", translationKey: "prompts.category.threat_intel", icon: Radar },
  { id: "code-analysis", translationKey: "prompts.category.code_analysis", icon: Code2 },
  { id: "infrastructure", translationKey: "prompts.category.infrastructure", icon: Server },
  { id: "compliance", translationKey: "prompts.category.compliance", icon: FileCheck },
];
...
const PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    description:
      "Collect and correlate threat intelligence from dark web forums, marketplaces, and paste sites.",
...
function PromptItem({ prompt, index }: { prompt: Prompt; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group cursor-pointer rounded-xl border text-left transition-all duration-200",
        expanded
      ...
      <div className="flex items-center gap-3 px-4 py-3">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <button
            ...
            className={cn(
              "grid size-10 place-items-center rounded-lg border transition-all duration-200",
              copied
            ...
            <div className="border-t border-border/50 px-4 py-3">
              <div className="mb-2 flex items-center justify-between">
                ...
                <button
                  type="button"
                  onClick={handleCopy}
                  aria-label={copied ? "Copied" : "Copy prompt template"}
                  className={cn(
    ...
    <section className="px-6 py-28">
      <div className="mx-auto max-w-4xl">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <StatusPill tone="accent">{t("prompts.badge")}</StatusPill>
        ...
        <AnimatePresence mode="wait">
          {totalCount > 0 ? (
            ...
            >
              ...
              <p className="mt-3 text-sm text-muted-foreground">{t("prompts.empty")}</p>
              <button
                type="button"
                onClick={() => {
