...
const PROMPTS: Prompt[] = [
  ...
  },
  {
    ...
    description: "Audit Kubernetes RBAC configurations for privilege escalations, wildcard bindings, and excessive permissions.",
  ...
  },
  {
    ...
    usage: "Upon discovery of suspicious files or during incident investigation.",
  ...
  },
  {
    ...
    description: "Gather and correlate threat intelligence from dark web forums, marketplaces, and paste sites relevant to your organization.",
    usage: "Weekly threat intelligence gathering or after targeted alert.",
  ...
  },
  {
    ...
    usage: "CI/CD pipeline gate or registry sweep.",
  ...
  },
  {
    ...
    usage: "Annual GDPR audit or before launching in EU markets.",
  ...
  },
  {
    ...
    description: "Analyze CloudTrail / audit logs for anomalous API calls, privilege escalations, and unauthorized resource creation.",
    usage: "Daily security monitoring or post-incident forensic review.",
  ...
  },
  {
    ...
    description: "Execute a structured ransomware response including containment, negotiation prep, and recovery procedures.",
    usage: "Immediately upon ransomware detection or encryption alert.",
  ...
  },
  {
    ...
    description: "Correlate network flow logs with threat intelligence feeds to identify C2 communication and data exfiltration.",
    usage: "Continuous monitoring or after detection of suspicious outbound traffic.",
  ...
  },
  {
    ...
    usage: "Pre-deployment CI/CD gate or infrastructure review.",
  ...
  },
  {
    ...
    description: "Perform forensic acquisition of volatile and non-volatile data from compromised systems with chain-of-custody.",
    usage: "During incident response or legal hold situations.",
  ...
  },
  {
    ...
    description: "Assess the impact and exploitation risk of newly disclosed vulnerabilities in your technology stack.",
    usage: "Upon disclosure of a critical CVE or vendor advisory.",
  ...
  },
  {
    ...
    description: "Correlate logs from multiple sources (SIEM, endpoints, network) to identify complex attack chains.",
    usage: "During incident investigation or weekly threat review.",
  ...
  },
  {
    ...
    usage: "Quarterly compliance validation or after infrastructure changes to CDE.",
    tags: ["pci", "cd", "asv"],
  ...
  },
  {
    ...
    category: "infrastructure",
    categoryIcon: Server,
    title: "SOC Runbook Generation",
    description: "Generate a complete SOC runbook covering triage, escalation, and response procedures for common alert types.",
    usage: "New SOC setup or runbook consolidation effort.",
  ...
  },
  {
    ...
    usage: "Upon cluster security alert or suspicious workload detection.",
  ...
  },
  {
    ...
    description: "Inventory and validate all cryptographic assets: certificates, keys, HSMs, and cipher suites across the infrastructure.",
  ...
  },
  {
    ...
    usage: "Quarterly DLP effectiveness review or after data breach.",
