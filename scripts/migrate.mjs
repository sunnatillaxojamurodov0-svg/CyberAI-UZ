...
function runMigrations() {
  ...
  console.log(
    "  npx wrangler d1 execute cyberai-db --remote --file=./drizzle/migrations/<filename>.sql",
  );
}
...
function resetDatabase() {
  ...
  console.log(
    "Use 'npx wrangler d1 execute cyberai-db --command \"DROP TABLE IF EXISTS ...\"' instead.",
  );
}
